...
# Keep-Alive URL
URL = environ.get("URL", "")  # <-- Add this line

CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/bdc720faf2ff35cf92563.jpg https://envs.sh/2u4.jpg https://envs.sh/2u1.jpg')).split()  # Sample pic
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/2FC.jpg'))
FSUB_IMG = (environ.get('FSUB_IMG', 'https://envs.sh/2FC.jpg')).split() 
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/DramaChats') 
